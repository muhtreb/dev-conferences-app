<template>
  <div class="relative inline-block">
    <button class="rounded px-2 py-1 hover:bg-gray-600 transition-colors duration-200 ease-in-out" @click="toggleDropdown" :aria-expanded="showDropdown" aria-controls="user-dropdown">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="inline-block w-5 h-5 mr-2">
      ...
      <ul class="list-reset">
        <li class="border-b-2 border-gray-700">
          <a href="/user/favorite" class="hover:underline p-2 inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="inline-block w-4 h-4 mr-2">
